...
char* concatena(char* str1, char* str2) {
    if (str1 == NULL || str2 == NULL) {
        fprintf(stderr, "Error: NULL string passed to concatena\n");
        return NULL;
    }
    char* result = NULL;
    if (asprintf(&result, "%s%s", str1, str2) == -1) {
         perror("asprintf failed in concatena");
         return NULL;
    }
    return result;
}
...
{
       0,   145,   145,   145,   175,   182,   188,   191,   195,   207,
     222,   246,   274,   279,   282,   302,   304,   354,   382,   436,
     437,   442,   443,   451,   492,   522,   553,   588,   600,   612,
     624,   638,   687,   697,   701,   715
};
#endif
...
static const char *const yytname[] =
{
  ...
  "MINUSOP", "DIV", "POR", "NUM", "ID", "STRING", "UMINUS", "$accept",
...
{
     -57,    26,   -23,   -57,    25,    35,    22,   -57,     1,    42,
      42,    12,   -57,    29,    40,    39,    49,    56,    57,   -57,
     -57,    68,   -57,   -57,     4,    69,    17,    44,    38,    38,
      -1,    36,    38,   -57,    46,    38,   -57,    60,   -57,    -3,
      38,    38,   -57,   -57,    58,    70,   -57,     2,   -57,    89,
     -57,    85,   -57,    89,    72,    75,    64,    54,   -57,    48,
      38,    38,    38,    38,    48,    91,    -1,   -57,    38,   -57,
     -57,   -57,    38,   105,    19,    19,   -57,   -57,   -57,   -57,
     -57,    89,    80,    48,    38,   -57,    74,   -57
};
...
{
      44,    45,     4,    73,    51,     9,    10,    53,    78,    55,
      40,    56,    57,    58,    65,    15,    66,    33,    34,    16,
      41,    17,    18,    42,    43,    46,     3,    85,    19,    20,
      36,    37,    74,    75,    76,    77,     5,    21,     7,    15,
      81,    62,    63,    16,    82,    17,    18,     6,    12,    40,
      27,    15,    19,    50,    23,    16,    86,    17,    18,    41,
      28,    21,    42,    43,    19,    25,    71,    29,    30,    38,
      59,    52,    72,    21,    60,    61,    62,    63,    60,    61,
      62,    63,    64,    32,    35,    54,    87,    68,    69,    70,
      60,    61,    62,    63,    60,    61,    62,    63,    67,    84,
      60,    61,    62,    63,    79,    60,    61,    62,    63,    60,
      61,    62,    63,    83,    14,    31,    80
};

static const yytype_int8 yycheck[] =
{
      28,    29,    25,    59,    32,     4,     5,    35,    64,    12,
      11,    14,    40,    41,    12,     3,    14,    13,    14,     7,
      21,     9,    10,    24,    25,    26,     0,    83,    16,    17,
      13,    14,    60,    61,    62,    63,    11,    25,    16,     3,
      68,    22,    23,     7,    72,     9,    10,    12,     6,    11,
      11,     3,    16,    17,    25,     7,    84,     9,    10,    21,
      11,    25,    24,    25,    16,    25,    12,    11,    11,    25,
      12,    25,    18,    25,    20,    21,    22,    23,    20,    21,
      22,    23,    12,    15,    15,    25,    12,    15,    13,    25,
      20,    21,    22,    23,    20,    21,    22,    23,    13,    19,
      20,    21,    22,    23,    13,    20,    21,    22,    23,    20,
      21,    22,    23,     8,    10,    19,    66
};
...
{
       0,    29,    30,     0,    25,    11,    12,    16,    31,     4,
       5,    35,     6,    32,    32,     3,     7,     9,    10,    16,
      17,    25,    36,    25,    33,    25,    34,    11,    11,    11,
      11,    35,    15,    13,    14,    15,    13,    14,    25,    39,
      11,    21,    24,    25,    40,    40,    26,    37,    38,    40,
      17,    40,    25,    40,    25,    12,    14,    40,    40,    12,
      20,    21,    22,    23,    12,    12,    14,    13,    15,    13,
      25,    12,    18,    36,    40,    40,    40,    40,    36,    13,
...
// etiqueta1
			char *etiq = while_nuevaEtiqueta();
			Operacion op;
			op.op = malloc(16);
			sprintf(op.op, "%s:", etiq);
			op.arg1 = NULL;
			op.arg2 = NULL;
			op.res = NULL;
...
// beqz
			Operacion op2;
			op2.op = "beqz";
			op2.arg1 = recuperaResLC((yyvsp[-2].lc));
			op2.arg2 = fin_while_nuevaEtiqueta();
			op2.res = NULL;

			insertaLC((yyval.lc), finalLC((yyval.lc)), op2);
			liberaRegistro(op2.arg1);
...
// b
			...
			insertaLC((yyval.lc), finalLC((yyval.lc)), op3);

// etiqueta2
			Operacion op4;
			op4.op = malloc(16);
			sprintf(op4.op, "%s:", op2.arg2);
			op4.arg1 = NULL;
			op4.arg2 = NULL;
			op4.res = NULL;

			insertaLC((yyval.lc), finalLC((yyval.lc)), op4);
...
#line 638 "sintactico.y"
            ...
            op.op = "beqz";
            op.arg1 = recuperaResLC((yyvsp[-5].lc));
            op.arg2 = etiq1;
            op.res = NULL;
            insertaLC((yyval.lc), finalLC((yyval.lc)), op);
            ...
            guardaResLC((yyval.lc), recuperaResLC((yyvsp[-3].lc)));  // O podría ser $6, depende de qué camino se tome
...
#line 697 "sintactico.y"
                                 {
            (yyval.lc) = (yyvsp[-1].lc); // Code is just the inner expression's code
          }
...
/* Changed signature to accept const char* */
void yyerror(const char *s) {
